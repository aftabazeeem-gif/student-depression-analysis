...
The project is built using the Statistics Template JS and integrates a SQLite database, SQL queries, and Google Charts to present results through tables and visualizations.
...
- Categorical data (e.g. sleep duration) was structured to allow easier statistical analysis

Using SQLite enabled efficient data handling and allowed the use of SQL queries for analysis.
